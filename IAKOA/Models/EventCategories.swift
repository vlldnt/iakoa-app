struct EventCategories {
    static let dict: [String: (label: String, icon: String, color: String)] = [
        ...
        "soiréejeux": ("Soirée jeux", "gamecontroller", "#5D9CEC"),
        "lecture": ("Lecture", "book.fill", "#3E5569"),
        "repas": ("Repas", "fork.knife", "#D38D5F"),
        "déjeuner": ("Déjeuner", "takeoutbag.and.cup.and.straw.fill", "#E8A87C"),
        ...
        "marche": ("Marché", "basket.fill", "#5E8D65"),
        ...
        "développementpersonnel": ("Développement personnel", "brain.head.profile", "#355C7D"),
        
        // 🎓 Éducation & Conférences
        "conférence": ("Conférence", "person.2.wave.2", "#A0A8B2"),
        ...
        "découverte": ("Découverte", "magnifyingglass", "#F4A261"),
        ...
        "bénévolat": ("Bénévolat", "hands.clap", "#2A9D8F"),
        "écologie": ("Écologie", "leaf.arrow.circlepath", "#88B04B"),
        "solidarité": ("Solidarité", "person.3.fill", "#F8B195"),
        "rencontre": ("Rencontre", "person.2.fill", "#4ECDC4"),
        "événementcaritatif": ("Événement caritatif", "heart", "#E63946"),
